...
public class VulkanPhysicalDevice {
    ...
    public static VulkanPhysicalDevice createPhysicalDevice(VulkanInstance instance) throws UnknownServiceException {
        Logger.debug("Selecting physical devices");
        VulkanPhysicalDevice selectedPhysicalDevice = null;
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            if (numDevices <= 0) {
                throw new UnknownServiceException("No physical devices found");
            }
